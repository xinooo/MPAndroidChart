...
public class DoubleXLabelAxisRenderer extends MyXAxisRenderer {

    private IAxisValueFormatter topValueFormatter;


    public DoubleXLabelAxisRenderer(ViewPortHandler viewPortHandler, XAxis xAxis, Transformer trans, IAxisValueFormatter formatter) {
        super(viewPortHandler, xAxis, trans);
        this.topValueFormatter = formatter;
    }
